...
@Getter
@Setter
@Schema(description = "药品商品主信息表AddParams对象")
public class BusinessDrugGoodsAddParams implements Serializable {
    ...
    private List<BusinessDrugGoodsCertAddParams> certs = List.of();;
