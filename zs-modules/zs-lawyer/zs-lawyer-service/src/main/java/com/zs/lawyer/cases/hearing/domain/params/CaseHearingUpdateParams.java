...
@Getter
@Setter
@Schema(description = "案件开庭信息updateParams对象")
public class CaseHearingUpdateParams implements Serializable {
    ...
    private List<CaseInfoFilesUpdateParams> caseHearingFilesList = List.of();
