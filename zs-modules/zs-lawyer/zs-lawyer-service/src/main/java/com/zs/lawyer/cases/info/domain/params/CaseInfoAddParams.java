...
public class CaseInfoAddParams implements Serializable {
    ...
    private List<CaseRelatedPartiesAddParams> ourSide;

    private List<CaseRelatedPartiesAddParams> otherSide;
