...
@Getter
@Setter
@Schema(description = "案件合同AddParams对象")
public class CaseContractAddParams implements Serializable {
    ...
    private List<CaseContractNodeAddParams> contractNodeList;

    @Schema(description = "合同附件列表")
//    private List<CaseContractFilesAddParams> contractFileList;
    private List<CaseInfoFilesAddParams> contractFileList;
