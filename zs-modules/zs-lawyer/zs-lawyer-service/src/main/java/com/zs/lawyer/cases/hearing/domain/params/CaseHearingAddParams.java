...
@Getter
@Setter
@Schema(description = "案件开庭信息AddParams对象")
public class CaseHearingAddParams implements Serializable {
...
//    private List<CaseHearingFilesAddParams> caseHearingFilesList = List.of();

    private List<CaseInfoFilesAddParams> caseHearingFilesList = List.of();;
